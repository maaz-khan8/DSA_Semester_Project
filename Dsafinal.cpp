...
public:
    ...
    void generateInvoice(Taxi taxi, User user, double fare, string dest, string pick, int carTypeMultiplier, int time)
    {
        ...
        cout << "Fare: $" << fare << endl;
        cout << "Estimate arrival in: " << time + 15 << " Minutes " << endl;
...
public:
    ...
    void processChoice(char choice)
    {
        ...
        case '2':
            ...
            do
            {
                cout << "Enter your phone number (Exact 11 digits): ";
                getline(cin, number);
...
int main()
{
    ...
    while (true)
    {
        ...
        if (ans == 1)
        {
            ...
            if (confirm == 1)
            {
                billing.generateInvoice(bookedTaxi, p, fare, destination, pickupLocation, m.carTypeMultiplier, time);
            }
            else
            {
